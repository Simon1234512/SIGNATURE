            ...
            <div className="privacy-policy">
              ...
              <div className="privacy-policy-content">
                <p>
                  ...
                  customers (“Customers”), our Customers’ clients (“Clients”)
                  and of any user of our websites and other services including
                  job applicants and alike (together with Customers and Clients,
                  ...
                  and any subdomains (together “Websites”), web applications
                  (“Web Apps”), mobile applications (“Mobile Apps”), our App
                  Market, our WiseStamp services and any related services
                ...
                <p>
                  Please read this Privacy Policy before using any of our
                  Services or providing us with any information or data. BY
                  USING OUR WEBSITES OR ANY OF OUR SERVICES, YOU ARE CONSENTING
                  TO THIS PRIVACY POLICY. If you do not agree to the terms of
                  this Privacy Policy, please discontinue use of our Services
                  and immediately leave our Website. This Privacy Policy
        ...
        <Container className="main">
            ...
            <div className="privacy-policy-bottom">
              ...
              <ul>
                <li>
                  ...
                  mailing address, home/business address, email and phone
                  number;
                </li>
                <li>
                  Other identifying information: unique personal identifiers
                  such as Social Security number, driver’s license, state
                ...
                <li>
                  Demographic information: gender, age, employment information
                ...
                <li>
                  ...
                  other financial information such as the four last digits of
                  your credit card; transactions associated with your use of the
                  Services, including the transaction ID, transaction category
                  and type, merchant name, amount, currency, date, and
                  location;x
                </li>
                ...
                <li>
                  ...
                  type, search and click history; navigation within and use of
                ...
                <li>
                  Inferences drawn from the categories described above in order
                  to create customized Services to reflect your preferences,
          ...
          <Container className="sm">
            ...
            <div className="privacy-policy-bottom ">
              ...
              <ul>
                <li>
                  When you register as a Customer, use the Services or purchase
                  an App on our App Market you will be required to provide us
                  with information. To the extent applicable, such details will
                  be provided by using your social network account (e.g.
                  connecting your Facebook or Google account to our Services).
                </li>
                <li>
